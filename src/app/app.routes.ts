...
import { NationalsPlayerComponent } from './national-players/nationals-player.component';
...
export const routes: Routes = [
    ...
    { path: 'nationals-player', component: NationalsPlayerComponent, canActivate: [authGuard] }
];
